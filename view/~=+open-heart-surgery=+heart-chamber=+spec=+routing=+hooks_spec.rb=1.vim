...
setlocal path=.,~/open-heart-surgery/heart-chamber,~/open-heart-surgery/heart-chamber/app,~/open-heart-surgery/heart-chamber/app/models,~/open-heart-surgery/heart-chamber/app/controllers,~/open-heart-surgery/heart-chamber/app/helpers,~/open-heart-surgery/heart-chamber/config,~/open-heart-surgery/heart-chamber/lib,~/open-heart-surgery/heart-chamber/app/views,~/open-heart-surgery/heart-chamber/spec,~/open-heart-surgery/heart-chamber/spec/models,~/open-heart-surgery/heart-chamber/spec/controllers,~/open-heart-surgery/heart-chamber/spec/helpers,~/open-heart-surgery/heart-chamber/spec/views,~/open-heart-surgery/heart-chamber/spec/lib,~/open-heart-surgery/heart-chamber/spec/requests,~/open-heart-surgery/heart-chamber/spec/integration,~/open-heart-surgery/heart-chamber/app/*,~/open-heart-surgery/heart-chamber/vendor,~/open-heart-surgery/heart-chamber/vendor/plugins/*/lib,~/open-heart-surgery/heart-chamber/vendor/plugins/*/test,~/open-heart-surgery/heart-chamber/vendor/rails/*/lib,~/open-heart-surgery/heart-chamber/vendor/rails/*/test,/usr/local/lib/site_ruby/1.8,/usr/local/lib/site_ruby/1.8/x86_64-linux,/usr/local/lib/site_ruby,/usr/lib/ruby/vendor_ruby/1.8,/usr/lib/ruby/vendor_ruby/1.8/x86_64-linux,/usr/lib/ruby/vendor_ruby,/usr/lib/ruby/1.8,/usr/lib/ruby/1.8/x86_64-linux,,/var/lib/gems/1.8/gems/rubyzip-0.9.4/lib
